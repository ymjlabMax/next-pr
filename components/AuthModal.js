                            ...
                            <div className="py-12">
                                <div className="px-4 sm:px-12">
                                    ...
                                    <div className="mt-10">
                                        ...
                                        {/* Sign with email */}
                                        <Formik initialValues={{ email: "" }} validationSchema={SignInSchema} validateOnBlur={false} onSubmit={signInWithEmail}>
                                            {({ isSubmitting, isValid, values, resetForm }) => (
                                                <Form className="mt-4">
                                                    <Input name="email" type="email" placeholder="elon@spacex.com" disabled={disabled} spellCheck={false} />
